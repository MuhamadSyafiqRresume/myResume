...
//                        System.out.println(points);
    ...
    public void mainMovemonet(Tile abcd, Player user, int row, int column, int[][] tiles, int[][] undo ) {
        ...
        System.out.println("Game Over. Your score is "+points);
        user.getScore();
